          ...
          registration.addEventListener("updatefound", () => {
            ...
            installing.addEventListener("statechange", () => {
              if (
                ...
                // a new version has been installed and is waiting to
                // take over on the next full reload
                document.dispatchEvent(
                  new CustomEvent("scoutwave:sw-update-available")
                );

                if (window.toast?.info) {
                  window.toast.info(
                    "A new version of Scoutwave is available.",
                    {
                      action: {
                        label: "Refresh",
