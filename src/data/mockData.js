...
export const trackRecord = {
  overall: 71,
  byMarket: [
    { label: "Match winner", pct: 78 },
    { label: "BTTS", pct: 58 },
    { label: "Over/Under 2.5", pct: 66 },
  ],
};
...
export const newsArticles = [
  ...
  {
    id: 4,
    title: "VIP tips hit rate climbs to 71% over last 30 picks",
    source: "Scoutwave Desk",
    time: "1d ago",
    category: "Scoutwave",
    featured: false,
    snippet: "Match-winner tips continue to outperform BTTS markets across the last month of tracked results.",
    gradient: ["#8C6E2A", "#493812"],
  },
];

export const faqItems = [
  { q: "How is the VIP hit rate calculated?", a: "We track every tip we publish against its final result and roll up a trailing 30-tip window, broken down by market type." },
