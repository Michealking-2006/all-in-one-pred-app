  ...
  searchInput.addEventListener("input", () => {
    ...
    debounceTimer = setTimeout(() => {
      ...
      searchLeagues(query)
        ...
        .catch(() => {
          resultsSection.innerHTML = "";
          resultsSection.appendChild(text("div", { style: { padding: "30px 18px", fontSize: "13px", color: "var(--danger)", textAlign: "center" } }, "Couldn't load results \u2014 check your connection."));
        });
    }, 350);
  });
