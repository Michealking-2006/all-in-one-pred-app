...
export function LanguageScreen({current,onSelect,onBack}){
 return h("main",{className:"screen language-screen"},[
  ...
  h("section",{className:"selection-list card"},languages.map(lang=>h("button",{className:"selection-row",onClick:()=>onSelect(lang)},[text("span",{},lang),lang===current?h("i",{"data-lucide":"check"}):null]))),
