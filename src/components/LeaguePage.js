...
import { metaLine, entityRow, entityList, segmented, seasonPicker, seasonSlot, favoriteStarButton } from "../utils/ui.js";
...
export function LeaguePage({ id, slug, onBack, isFavorite, onToggleFavorite }) {
  if (id) return createLeaguePage(id, onBack, isFavorite, onToggleFavorite);
...
function createLeaguePage(id, onBack, isFavorite, onToggleFavorite) {
