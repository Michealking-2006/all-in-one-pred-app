...
export function ProfileScreen({isVip,coins,favoritesCount,onOpenFavorites,onRequestUpgrade,onOpenCoins,currentLanguage,theme,onNavigate,avatarSrc,authUser,onOpenAuth,onSignOut}){
 return h("main",{className:"screen profile-screen"},[
  ...
  h("section",{className:"profile-group tone-orange"},[
   ...
   row({icon:"moon",label:"Appearance",trailing:text("span",{className:"profile-trailing"},THEME_LABEL[theme]||"System"),onClick:()=>onNavigate("appearance")})
  ]),
