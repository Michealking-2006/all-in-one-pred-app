...
const ICONS = {
  ...
  "key-round": '<circle cx="8" cy="15" r="4"/><path d="m11 12 6-6"/><path d="m18 6-2.5 2.5"/><path d="m14.5 9.5 5 5"/>',
  lock: '<rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>',
  mail: '<rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-10 7L2 7"/>',
  newspaper: '<path d="M4 22h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v14a2 2 0 0 1-2 2Zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2"/><path d="M18 14h-8"/><path d="M15 18h-5"/><path d="M10 6h8v4h-8V6Z"/>',
  ...
  twitter: '<path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5 1.5 9.6 2 4c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"/>',
  user: '<path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',
  volleyball: '<circle cx="12" cy="12" r="10"/><path d="M11.1 7.1a16.55 16.55 0 0 1 10.9 4"/><path d="M12 12a12.6 12.6 0 0 1-8.7 5"/><path d="M16.8 3.9A16.55 16.55 0 0 1 21 12"/><path d="M20.1 15.5A16.55 16.55 0 0 1 12 21"/><path d="M3.5 8.5A16.57 16.57 0 0 1 12 3"/><path d="M3 12a12.6 12.6 0 0 1 8.7-5"/>',
};

// Drop-in replacement for h("i", { "data-lucide": name, ... }) — same call
// shape, but renders real SVG immediately, synchronously, no external script.
const warned = new Set();
export function Icon(name, { size = 18, color = "currentColor", fill = "none", style = {}, ...rest } = {}) {
  const svg = h("svg", {
    viewBox: "0 0 24 24",
    width: String(size),
    height: String(size),
  ...
  if (!ICONS[name] && !warned.has(name)) {
    warned.add(name);
    console.warn("Scoutwave: missing icon \"" + name + "\" — add it to utils/icons.js");
  }
